...
import com.desirArman.blog.security.BlogUserDetailsService;
import com.desirArman.blog.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/like/**").authenticated() // ✅ added this

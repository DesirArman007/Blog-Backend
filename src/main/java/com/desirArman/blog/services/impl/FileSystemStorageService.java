...
import com.desirArman.blog.exception.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    @Override
    public Optional<Resource> loadAsResource(UUID filename) {
        try{
            Path file = rootLocation.resolve(filename.toString());
